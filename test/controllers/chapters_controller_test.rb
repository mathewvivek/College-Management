...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { course_id: @chapter.course_id, name: @chapter.name, order_number: @chapter.order_number }
    end
  ...
  test "should update chapter" do
    patch :update, id: @chapter, chapter: { course_id: @chapter.course_id, name: @chapter.name, order_number: @chapter.order_number }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
